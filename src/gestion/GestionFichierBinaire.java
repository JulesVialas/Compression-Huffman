...
public class GestionFichierBinaire {
	...
	try (DataInputStream input 
		       = new DataInputStream(new FileInputStream(nomFichier))) {
    ...
    /**
     * Convertit un octet en sa représentation binaire sous forme de 
     * chaîne.
     *
	...
	return String.format("%8s",
			Integer.toBinaryString(octet & 0xFF)).replace(' ', '0');
    }
     ...
     * 			   survient.
     */
    public static void ecriture(String stringBinaire,
