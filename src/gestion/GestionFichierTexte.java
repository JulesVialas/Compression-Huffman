...
/**
 * La classe GestionFichierTexte fournit des méthodes pour lire et écrire des
 * fichiers texte.
 */
public class GestionFichierTexte {

    /**
     * Lit le contenu d'un fichier texte et retourne ce contenu sous forme de chaîne
     * de caractères.
     *
