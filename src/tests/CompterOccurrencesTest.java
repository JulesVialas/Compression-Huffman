...
class CompterOccurrencesTest {
    ...
    private static final String[] TEXTE_NORMAL = { "Demain, des l'aube, a "
    	+ "l'heure ou blanchit la campagne,",
    ...
    private static final int[] RESULTAT_TEXTE_NORMAL = { 21, 21, 18, 16, 18, 
	    17, 16, 18, 19, 18, 19, 18 };
	...
	for (int rang = 0; rang < TEXTE_NORMAL.length; rang++) {
	    Object[][] resultat = CompterOccurrences.compter(
		    TEXTE_NORMAL[rang]);
