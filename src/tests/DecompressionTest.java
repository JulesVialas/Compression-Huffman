...
class DecompressionTest {
    ...
    private static final String NOM_FICHIER_TEMPORAIRE_COMPRESSE = 
	    "testFichierCompresse.bin";
    private static final String TEXTE = "hello world";
    private static final String TEXTE_COMPRESSE = 
	    "01101110100100110111101011001111000001";
	...
	assertTrue(fichierCompresse.exists(), "Le fichier compressé doit "
		+ "exister après l'écriture.");

	String texteDecompresse = Decompression.decompresser(
		NOM_FICHIER_TEMPORAIRE_COMPRESSE, DICTIONNAIRE);
